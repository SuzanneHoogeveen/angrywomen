...
#anger extremity b
bayes.extremeb <- apa_print(correlationBF(dat.anger$perc.anger, dat.anger$status, nullInterval = c(-1,0)), mcmc_error = F, reciprocal = T)$full_result
rho.extremeb <- correlationBF(dat.anger$perc.anger, dat.anger$status, posterior = TRUE, iterations = 10000)
#appropriateness
bayes.approp <- apa_print(correlationBF(dat.anger$approp, dat.anger$status, nullInterval = c(0,1)), mcmc_error = F, reciprocal = T)$full_result
